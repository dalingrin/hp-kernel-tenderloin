...
#define WEBCAM_DEV (&msm_camera_sensor_webcam_mt9m113.dev)
#else
...
static struct resource msm_uart10_dm_resources[] = {
    {
...
struct platform_device msm_device_uart_dm10 = {
    .name = "msm_serial_hsl",
    .id = 1,
    .num_resources = ARRAY_SIZE(msm_uart10_dm_resources),
    .resource = msm_uart10_dm_resources,
};
...
static int msm_uart4_dm_data[2] = {
	0x40,               //gsbi_protocol code
	64,                //Tx fifo size
};
...
struct platform_device msm_device_uart_dm4 = {
	...
	.dev = {
		.platform_data = msm_uart4_dm_data,
	}
};
/* End */
...
struct clk msm_clocks_8x60[] = {
	...
	CLK_8X60("gsbi_uart_clk",	GSBI10_UART_CLK,
	     &msm_device_uart_dm10.dev, OFF),
	/* HP SamLin 20110104, start for boradcom gps module 4751 uart port (gsbi 11) */
	CLK_8X60("gsbi_uart_clk",	GSBI11_UART_CLK,
					&msm_device_uart_dm4.dev, OFF),
	/* End */
	...
	CLK_8X60("gsbi_qup_clk",	GSBI4_QUP_CLK,
					&msm_gsbi4_qup_i2c_device.dev, OFF),
	CLK_8X60("gsbi_qup_clk",	GSBI5_QUP_CLK,
	                &msm_gsbi5_qup_spi_device.dev, OFF),
	...
	CLK_8X60("gsbi_qup_clk",	GSBI10_QUP_CLK,
	                &msm_gsbi10_qup_i2c_device.dev, OFF),             
	// Yegw End                
	...
	CLK_8X60("gsbi_pclk",		GSBI4_P_CLK,
					&msm_gsbi4_qup_i2c_device.dev, OFF),
	CLK_8X60("gsbi_pclk",		GSBI5_P_CLK,
					&msm_gsbi5_qup_spi_device.dev, OFF),
	CLK_8X60("uartdm_pclk",		GSBI6_P_CLK,
		&msm_device_uart_dm1.dev, OFF),
	...
	// Yegw End
	/* HP SamLin 20110104, start for boradcom gps module 4751 uart port (gsbi 11) */
	CLK_8X60("gsbi_pclk",		GSBI11_P_CLK,
					&msm_device_uart_dm4.dev, OFF),
	/* End */
