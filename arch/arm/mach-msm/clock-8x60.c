...
static struct clk_freq_tbl clk_tbl_pixel_mdp[] = {
	...
	F_PIXEL_MDP(100030000, MM_GPERF, 1, 10003, 38400, LOW), // HP Wade, this clock is over CPU spec
	F_END,
};
...
{
	/* HP_Hover[20101105] Fix the screen flash issue when boot from lk to kernel:
	 * Do not have to config the MM_PLL1 if it's already active
	 */
	if(!readl(MM_PLL1_STATUS_REG))
	{
