...
static int ulpi_write_with_reset(struct msm_otg *dev,unsigned val, unsigned reg);

static int usb_ulpi_write_with_reset(struct otg_transceiver *xceiv, u32 val, u32 reg)
{
	struct msm_otg *dev = container_of(xceiv, struct msm_otg, otg);
...
static int usb_ulpi_read_with_reset(struct otg_transceiver *xceiv, u32 reg)
{
	struct msm_otg *dev = container_of(xceiv, struct msm_otg, otg);
