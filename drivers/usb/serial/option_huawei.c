...
/*HP SamLin@20101216, Begin: Added for registering external modem device for Huawei 820u modem*/
int hw820u_exmdm_register(void);
void hw820u_exmdm_unregister(void);
/*HP SamLin@20101216, End: Added for registering external modem device for Huawei 820u modem*/
			...
			const struct usb_device_id *id)
{
    ...
    /*HP SamLin@20101216, Begin: Added for registering external modem device for Huawei 820u modem*/
		if (serial->dev->descriptor.idProduct == HUAWEI_PRODUCT_E1404
		  || serial->dev->descriptor.idProduct == HUAWEI_PRODUCT_E140C) {
