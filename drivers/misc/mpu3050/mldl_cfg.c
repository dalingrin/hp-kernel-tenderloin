...
static int MLDLDmpStart(struct mldl_cfg *pdata, void *mlsl_handle)
{
    ...
    MPL_LOGD("mldl_cfg MLDLDmpStart+\n");
		   ...
		   bool resume_accel, bool resume_compass)
{
    ...
    MPL_LOGD("mldl_cfg mpu3050_resume\n");
...
#define ML_SKIP_CHECK 20
	...
	if (resume_accel) {
		if ((!mldl_cfg->accel) || (!mldl_cfg->accel->resume))
 		...
 		MPL_LOGD("mldl_cfg resume_accel\n");
	...
	if (resume_compass) {
        MPL_LOGD("mldl_cfg resume_compass\n");
		    ...
		    bool accel, bool compass)
{
    ...
    MPL_LOGD("mldl_cfg mpu3050_suspend end\n");
	return result;
}
