...
#define PROCI_PLAMSUPPRESSION_T41                 41u
...
/* GEN_COMMANDPROCESSOR_T6 Message address definitions		*/
...
/* PROCG_NOISESUPPRESSION_T22 Message address definitions		*/
...
/* PROCI_ONETOUCHGESTUREPROCESSOR_T24 Message address definitions	*/
...
/* SPT_SELFTEST_T25 Message address definitions			*/
...
/* PROCI_TWOTOUCHGESTUREPROCESSOR_T27 Message address definitions	*/
...
/* SPT_CTECONFIG_T28 Message address definitions			*/
...
/* Two gesture Event */
#define MT_GESTURE_ROTATE               (1<<6)
#define MT_GESTURE_ROTATEDIR            (1<<4)
#define MT_GESTURE_STRETCH              (1<<7)
#define MT_GESTURE_PINCH                (1<<5) 
...
/*! ==PROCI_GRIPFACESUPPRESSION_T40==
 The T40 GRIPSUPPRESSION object provides grip boundary suppression 
*/
/*! \brief
 This structure is used to configure the GRIPSUPPRESSION object and
 should be made accessible to the host controller.
*/
typedef struct
{
...
/*! ==PROCI_GRIPFACESUPPRESSION_T41==
 The T41 PLAMSUPPRESSION object provides big area suppression
*/
/*! \brief
 This structure is used to configure the PLAMSUPPRESSION object and
 should be made accessible to the host controller.
*/
typedef struct
{
...
} proci_plamsuppression_t41_config_t;
...
#define MULTI_TOUCH_MAX_REPORTS_ID    10
#define MULTI_TOUCH_FIRST_REPORT_ID  2
...
typedef  struct 
{
    uint16_t xpos;      // x-axle value
    uint16_t ypos;      // y-axle value
    uint8_t  press;     // 1 --the point is press; 0 -- realse 
} multi_touch_point_info;

multi_touch_point_info  position[MULTI_TOUCH_MAX_REPORTS_ID] = {{0}};
