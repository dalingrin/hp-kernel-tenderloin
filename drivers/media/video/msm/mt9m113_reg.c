...
{0x098C, 0xFFFF, 0x2703, WORD_LEN, 0 }, 	// MCU_ADDRESS
{0x0990, 0xFFFF, 0x0280, WORD_LEN, 0 }, 	// MCU_DATA_0
{0x098C, 0xFFFF, 0x2705, WORD_LEN, 0 }, 	// MCU_ADDRESS
{0x0990, 0xFFFF, 0x01E0, WORD_LEN, 0 }, 	// MCU_DATA_0
{0x098C, 0xFFFF, 0x2707, WORD_LEN, 0 }, 	// MCU_ADDRESS
{0x0990, 0xFFFF, 0x0500, WORD_LEN, 0 }, 	// MCU_DATA_0
{0x098C, 0xFFFF, 0x2709, WORD_LEN, 0 }, 	// MCU_ADDRESS
{0x0990, 0xFFFF, 0x0400, WORD_LEN, 0 }, 	// MCU_DATA_0
{0x098C, 0xFFFF, 0x270D, WORD_LEN, 0 }, 	// MCU_ADDRESS
{0x0990, 0xFFFF, 0x0000, WORD_LEN, 0 }, 	// MCU_DATA_0
{0x098C, 0xFFFF, 0x270F, WORD_LEN, 0 }, 	// MCU_ADDRESS
{0x0990, 0xFFFF, 0x0000, WORD_LEN, 0 }, 	// MCU_DATA_0
{0x098C, 0xFFFF, 0x2711, WORD_LEN, 0 }, 	// MCU_ADDRESS
{0x0990, 0xFFFF, 0x03CD, WORD_LEN, 0 }, 	// MCU_DATA_0
{0x098C, 0xFFFF, 0x2713, WORD_LEN, 0 }, 	// MCU_ADDRESS
{0x0990, 0xFFFF, 0x050D, WORD_LEN, 0 }, 	// MCU_DATA_0
{0x098C, 0xFFFF, 0x2715, WORD_LEN, 0 }, 	// MCU_ADDRESS
{0x0990, 0xFFFF, 0x2111, WORD_LEN, 0 }, 	// MCU_DATA_0
{0x098C, 0xFFFF, 0x2717, WORD_LEN, 0 }, 	// MCU_ADDRESS
{0x0990, 0xFFFF, 0x046C, WORD_LEN, 0 }, 	// MCU_DATA_0
{0x098C, 0xFFFF, 0x2719, WORD_LEN, 0 }, 	// MCU_ADDRESS
{0x0990, 0xFFFF, 0x00AC, WORD_LEN, 0 }, 	// MCU_DATA_0
{0x098C, 0xFFFF, 0x271B, WORD_LEN, 0 }, 	// MCU_ADDRESS
{0x0990, 0xFFFF, 0x01F1, WORD_LEN, 0 }, 	// MCU_DATA_0
{0x098C, 0xFFFF, 0x271D, WORD_LEN, 0 }, 	// MCU_ADDRESS
{0x0990, 0xFFFF, 0x013F, WORD_LEN, 0 }, 	// MCU_DATA_0
{0x098C, 0xFFFF, 0x271F, WORD_LEN, 0 }, 	// MCU_ADDRESS
{0x0990, 0xFFFF, 0x032E, WORD_LEN, 0 }, 	// MCU_DATA_0
{0x098C, 0xFFFF, 0x2721, WORD_LEN, 0 }, 	// MCU_ADDRESS
{0x0990, 0xFFFF, 0x04CC, WORD_LEN, 0 }, 	// MCU_DATA_0
{0x098C, 0xFFFF, 0x2723, WORD_LEN, 0 }, 	// MCU_ADDRESS
{0x0990, 0xFFFF, 0x0004, WORD_LEN, 0 }, 	// MCU_DATA_0
{0x098C, 0xFFFF, 0x2725, WORD_LEN, 0 }, 	// MCU_ADDRESS
{0x0990, 0xFFFF, 0x0004, WORD_LEN, 0 }, 	// MCU_DATA_0
{0x098C, 0xFFFF, 0x2727, WORD_LEN, 0 }, 	// MCU_ADDRESS
{0x0990, 0xFFFF, 0x040B, WORD_LEN, 0 }, 	// MCU_DATA_0
{0x098C, 0xFFFF, 0x2729, WORD_LEN, 0 }, 	// MCU_ADDRESS
{0x0990, 0xFFFF, 0x050B, WORD_LEN, 0 }, 	// MCU_DATA_0
{0x098C, 0xFFFF, 0x272B, WORD_LEN, 0 }, 	// MCU_ADDRESS
{0x0990, 0xFFFF, 0x2111, WORD_LEN, 0 }, 	// MCU_DATA_0
{0x098C, 0xFFFF, 0x272D, WORD_LEN, 0 }, 	// MCU_ADDRESS
{0x0990, 0xFFFF, 0x0024, WORD_LEN, 0 }, 	// MCU_DATA_0
{0x098C, 0xFFFF, 0x272F, WORD_LEN, 0 }, 	// MCU_ADDRESS
{0x0990, 0xFFFF, 0x004C, WORD_LEN, 0 }, 	// MCU_DATA_0
{0x098C, 0xFFFF, 0x2731, WORD_LEN, 0 }, 	// MCU_ADDRESS
{0x0990, 0xFFFF, 0x00F9, WORD_LEN, 0 }, 	// MCU_DATA_0
{0x098C, 0xFFFF, 0x2733, WORD_LEN, 0 }, 	// MCU_ADDRESS
{0x0990, 0xFFFF, 0x00A7, WORD_LEN, 0 }, 	// MCU_DATA_0
{0x098C, 0xFFFF, 0x2735, WORD_LEN, 0 }, 	// MCU_ADDRESS
{0x0990, 0xFFFF, 0x0559, WORD_LEN, 0 }, 	// MCU_DATA_0
{0x098C, 0xFFFF, 0x2737, WORD_LEN, 0 }, 	// MCU_ADDRESS
{0x0990, 0xFFFF, 0x0722, WORD_LEN, 0 }, 	// MCU_DATA_0
{0x098C, 0xFFFF, 0x2739, WORD_LEN, 0 }, 	// MCU_ADDRESS
{0x0990, 0xFFFF, 0x0000, WORD_LEN, 0 }, 	// MCU_DATA_0
{0x098C, 0xFFFF, 0x273B, WORD_LEN, 0 }, 	// MCU_ADDRESS
{0x0990, 0xFFFF, 0x027F, WORD_LEN, 0 }, 	// MCU_DATA_0
{0x098C, 0xFFFF, 0x273D, WORD_LEN, 0 }, 	// MCU_ADDRESS
{0x0990, 0xFFFF, 0x0000, WORD_LEN, 0 }, 	// MCU_DATA_0
{0x098C, 0xFFFF, 0x273F, WORD_LEN, 0 }, 	// MCU_ADDRESS
{0x0990, 0xFFFF, 0x01DF, WORD_LEN, 0 }, 	// MCU_DATA_0
{0x098C, 0xFFFF, 0x2747, WORD_LEN, 0 }, 	// MCU_ADDRESS
{0x0990, 0xFFFF, 0x0000, WORD_LEN, 0 }, 	// MCU_DATA_0
{0x098C, 0xFFFF, 0x2749, WORD_LEN, 0 }, 	// MCU_ADDRESS
{0x0990, 0xFFFF, 0x04FF, WORD_LEN, 0 }, 	// MCU_DATA_0
{0x098C, 0xFFFF, 0x274B, WORD_LEN, 0 }, 	// MCU_ADDRESS
{0x0990, 0xFFFF, 0x0000, WORD_LEN, 0 }, 	// MCU_DATA_0
{0x098C, 0xFFFF, 0x274D, WORD_LEN, 0 }, 	// MCU_ADDRESS
{0x0990, 0xFFFF, 0x03FF, WORD_LEN, 0 }, 	// MCU_DATA_0
{0x098C, 0xFFFF, 0x222D, WORD_LEN, 0 }, 	// MCU_ADDRESS
{0x0990, 0xFFFF, 0x00CC, WORD_LEN, 0 }, 	// MCU_DATA_0
{0x098C, 0xFFFF, 0xA404, WORD_LEN, 0 }, 	// MCU_ADDRESS
{0x0990, 0xFFFF, 0x0010, WORD_LEN, 0 }, 	// MCU_DATA_0
{0x098C, 0xFFFF, 0xA408, WORD_LEN, 0 }, 	// MCU_ADDRESS
{0x0990, 0xFFFF, 0x0032, WORD_LEN, 0 }, 	// MCU_DATA_0
{0x098C, 0xFFFF, 0xA409, WORD_LEN, 0 }, 	// MCU_ADDRESS
{0x0990, 0xFFFF, 0x0034, WORD_LEN, 0 }, 	// MCU_DATA_0
{0x098C, 0xFFFF, 0xA40A, WORD_LEN, 0 }, 	// MCU_ADDRESS
{0x0990, 0xFFFF, 0x003C, WORD_LEN, 0 }, 	// MCU_DATA_0
{0x098C, 0xFFFF, 0xA40B, WORD_LEN, 0 }, 	// MCU_ADDRESS
{0x0990, 0xFFFF, 0x003E, WORD_LEN, 0 }, 	// MCU_DATA_0
{0x098C, 0xFFFF, 0x2411, WORD_LEN, 0 }, 	// MCU_ADDRESS
{0x0990, 0xFFFF, 0x00CC, WORD_LEN, 0 }, 	// MCU_DATA_0
{0x098C, 0xFFFF, 0x2413, WORD_LEN, 0 }, 	// MCU_ADDRESS
{0x0990, 0xFFFF, 0x00F4, WORD_LEN, 0 }, 	// MCU_DATA_0
{0x098C, 0xFFFF, 0x2415, WORD_LEN, 0 }, 	// MCU_ADDRESS
{0x0990, 0xFFFF, 0x0089, WORD_LEN, 0 }, 	// MCU_DATA_0
{0x098C, 0xFFFF, 0x2417, WORD_LEN, 0 }, 	// MCU_ADDRESS
{0x0990, 0xFFFF, 0x00A4, WORD_LEN, 0 }, 	// MCU_DATA_0
{0x098C, 0xFFFF, 0xA40D, WORD_LEN, 0 }, 	// MCU_ADDRESS
{0x0990, 0xFFFF, 0x0002, WORD_LEN, 0 }, 	// MCU_DATA_0
{0x098C, 0xFFFF, 0xA40E, WORD_LEN, 0 }, 	// MCU_ADDRESS
{0x0990, 0xFFFF, 0x0003, WORD_LEN, 0 }, 	// MCU_DATA_0
{0x098C, 0xFFFF, 0xA410, WORD_LEN, 0 }, 	// MCU_ADDRESS
...
{0x0990, 0xFFFF, 0x00FF, WORD_LEN, 0 }, 	// MCU_DATA_0//
//Params added here to mirror preview frames as camera is at front. 0308 --Begin
{0x098C, 0xFFFF, 0x2717, WORD_LEN, 0 }, 	// MCU_ADDRESS [HG_GAMMA_TABLE_A_18]
{0x0990, 0xFFFF, 0x046D, WORD_LEN, 0 }, 	// MCU_DATA_0
{0x098C, 0xFFFF, 0x272D, WORD_LEN, 0 }, 	// MCU_ADDRESS [HG_GAMMA_TABLE_A_18]
{0x0990, 0xFFFF, 0x0025, WORD_LEN, 0 }, 	// MCU_DATA_0
//Params added here to mirror preview frames as camera is at front. 0308 --End
